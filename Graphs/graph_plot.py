...
# Crea il grafo da un file CSV (stesso codice precedente)
...
def plot_graph(G_nx):
    ...
    nx.draw(G_nx, pos, with_labels=True, node_color='lightblue', edge_color='gray', node_size=500, font_size=10)
