...
if __name__ == '__main__':
    ...
    """ NETWORKX EDGE CONNECTIVITY DOUBLING EXPERIMENTS GRAPHS CREATION """

    """ In this main nodes and edges are fixed to generate the graphs, according to 
    O(m*n*log n) NetworkX edge connectivity time complexity. 
    ...
    # TEST 1: check if O(m) part of the NetworkX edge connectivity time complexity is really linear, keeping n constant.
