"""
This script is used to execute the doubling experiment with NetworkX edge connectivity algorithm on
...
if __name__ == '__main__':
    ...
    """ NETWORKX EDGE CONNECTIVITY DOUBLING EXPERIMENT TESTS """
    """TEST 1.1: fixed number of nodes = 64, doubled number of edges"""
    try:
        # input directory
        input_dir = 'test_graphs/generated_graphs_test_1_1'
        print(f"Starting the doubling experiment test with NetworkX edge connectivity algorithm...")
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_1_1.csv'
    ...
    try:
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_1_2.csv'
            run_stoer_wagner_on_graphs(input_dir, output_file)
    ...
    try:
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_1_3.csv'
            run_stoer_wagner_on_graphs(input_dir, output_file)
    ...
    try:
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_2_1.csv'
            run_stoer_wagner_on_graphs(input_dir, output_file)
    ...
    try:
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_2_2.csv'
            run_stoer_wagner_on_graphs(input_dir, output_file)
    ...
    try:
        ...
        if check_all_graphs(input_dir):
            print("\nAll input test graphs are simple and undirected, not empty and not isolated. "
                  "Running NetworkX edge connectivity algorithm...")
            # stoer-wagner algorithm run
            output_file = 'results/generated_graphs/networkx_edge_connectivity_results_test_2_3.csv'
            run_stoer_wagner_on_graphs(input_dir, output_file)
