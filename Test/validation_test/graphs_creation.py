import os
import pandas as pd
from Graphs import nk_simple_connected_graph_generator
...
def generate_and_save_graphs(nodes_list, output_dir):
    ...
    for num_nodes in nodes_list:
        ...
        graph = nk_simple_connected_graph_generator.create_connected_simple_random_graph_with_weights(num_nodes)
